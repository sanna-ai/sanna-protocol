...
No schema, spec, fixture, or runtime code changes; CI workflow only.

### Tickets

- SAN-666 (this CI fix)
- SAN-647 (unblocked by this fix; PR #46 cross-sdk-smoke-python will pass on re-trigger after this merges)
- SAN-665 (the merge that unmasked the bug; sanna-repo Stage 2; merged 2026-05-18)
